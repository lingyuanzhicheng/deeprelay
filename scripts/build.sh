...
# Build flags
readonly LDFLAGS="-X 'github.com/lingyuanzhicheng/deeprelay/internal/conf.Version=${GIT_VERSION}' \
                  -X 'github.com/lingyuanzhicheng/deeprelay/internal/conf.BuildTime=${BUILD_TIME}' \
                  -X 'github.com/lingyuanzhicheng/deeprelay/internal/conf.Author=${GIT_AUTHOR}' \
